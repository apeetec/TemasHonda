...
<section class="simon-says-page">
    <div class="container">
        ...
        <header class="simon-header">
            ...
            <p class="simon-subtitle">Jogo de Memória e Sequência</p>
        </header>
        ...
        <div class="simon-instructions">
            <h3><i class="fa-solid fa-circle-info"></i> Como Jogar</h3>
            <ol>
                <li><strong>Observe</strong> — O jogo vai iluminar uma sequência de cores. Preste atenção!</li>
        ...
        <?php if ($tentativas_rest > 0): ?>
            <div class="simon-start-container">
                <button id="simon-start-btn" class="simon-start-btn" type="button">
                    <i class="fa-solid fa-play"></i> Iniciar Jogo
                </button>
            </div>
        <?php endif; ?>
        ...
        <div class="simon-player-info">
            <p>
                ...
                <?php if ($pontuacao_max > 0): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                | Tentativas restantes hoje: <strong><?php echo $tentativas_rest; ?></strong>
            </p>
        </div>

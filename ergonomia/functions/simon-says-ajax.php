...
function simon_save_game_callback()
{
    ...
    // Calcula número da tentativa atual do dia
    $tentativas_usadas = intval(get_user_meta($user_id, 'numero_tentativas', true));
    $tentativa_atual = $tentativas_usadas + 1;
    ...
    // Atualiza contadores de tentativas
    update_user_meta($user_id, 'numero_tentativas', $tentativa_atual);
    update_user_meta($user_id, 'simon_tentativas_restantes_hoje', $tentativas_restantes - 1);

    ...
    <article class="container">
        ...
        ?>
            <p class="data-liberacao" id="data_liberacao">
                Data de liberação do vídeo: <b><?php echo date("d/m",strtotime($data_inicio)); ?></b> às <b><?php echo str_replace(':00', 'h', date("H:i",strtotime($data_inicio))); ?></b>.
            </p>
        <?php
        }
    ...
    <article class="container">
        <form action="" method="POST" class="space-top" id="form-check">
            ...
            <div class="box-codigo <?php echo $sanitiza_term_name;?>">
                ...
                <!-- Avisos de código -->
                <div id="aviso-codigo-errado" class="aviso-erro" style="display: none;">
                    <span class="icone-erro">❌</span>
                    <span class="texto-erro">Código incorreto! Verifique e tente novamente.</span>
                </div>
                
                <div id="aviso-codigo-correto" class="aviso-sucesso" style="display: none;">
                    <span class="icone-sucesso">✅</span>
                    <span class="texto-sucesso">Código válido! Você está marcado como presencial.</span>
                </div>
                
                <div id="dica-codigo" class="dica-codigo" style="display: none;">
                    <span class="icone-dica">💡</span>
                    <span class="texto-dica">Digite o código de 5 caracteres fornecido na apresentação presencial</span>
                </div>
                
                <p class="row codigo">
                    <label class="s12 m6 l2 input-field"> 
                        <input type="text" id="input-codigo-presencial" name="codigo" data-error="wrong" placeholder="XXXXX" maxlength="7">           
